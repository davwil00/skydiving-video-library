...
export const AA_BLOCKS: Block[] = [
    ...
    {
        id: '13',
        startFormation: 'Mixed Accordions',
...
export const AAA_BLOCKS: Block[] = [
    {
        id: '3',
        startFormation: 'Side Flake Opal',
        endFormation: 'Turf',
        level: Level.AAA,
        discipline: Discipline.FOUR_WAY,
        type: Type.BLOCK,
...
export const EIGHT_WAY_BLOCKS: Block[] = [
    ...
    {
        id: '3',
        startFormation: 'Double Chinese Tees',
    ...
    {
        id: '13',
        startFormation: 'Double Satellite',
    ...
    {
        id: '19',
        startFormation: 'Compressed Diamonds',
...
export const EIGHT_WAY_FORMATIONS = [
    ...EIGHT_WAY_RANDOMS,
    ...EIGHT_WAY_BLOCKS,
].reduce(
    (acc, curr) => ({
