...
import { initialState, type Question, QuestionSet, quizReducer, QuizType } from '~/state/8-way-quiz-reducer';
                ...
                {choices.map((choice, idx) =>
                    ...
                    >
                        <img
                            ...
                            src={get8WayFormationImageUrl(choice)}
                        />
                    </button>
                )}
            </div>
            ...
            <div className="card text-black">
                ...
                <figure>
                    <img
                        ...
                        src={get8WayFormationImageUrl(currentQuestion.answer)}/>
                </figure>
