...
import {
    getCompetition,
    updateCompetition,
} from '~/models/competitions.server';
        ...
        <div>
            ...
            <form method="post" className="form-light flex flex-col">
                ...
                <div className="my-2">
                    ...
                    <ul className="list">
                        {Array.from(state.sessions).map((linkedSession) => (
                            <li
                    ...
                    <div className="join flex">
                        ...
                        <button
                            ...
                            onClick={() =>
                                dispatch({
                                    type: 'addSession',
                                    // biome-ignore lint/style/noNonNullAssertion: this will always be there
                                    session: sessions.find(
                                        (session) =>
                                            session.id ===
                                            sessionPicker.current?.value,
                                    )!,
                                })
                            }
                        >
                ...
                <button type="submit" className="btn mt-4 max-w-xs">
                    Update
                </button>
            </form>
        </div>
