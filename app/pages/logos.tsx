...
export default function logos() {
    return (
        <>
            ...
            <ul className="flex flex-wrap gap-2">
                <ImgObject
                    href=" images/logos/logo-with-text.pdf"
                    label="Logo with text"
                >
                    <PdfIcon className={`max-w-[95%] absolute m-[1px]`} />
                </ImgObject>
                <ImgObject
                    href="images/logos/logo-with-text-plain.svg"
                    label="Logo with text"
                    bordered={true}
                >
                    <object
                        data="images/logos/logo-with-text-plain.svg"
                        className={`max-w-[95%] absolute m-[1px]`}
                        type="image/svg+xml"
                    />
                </ImgObject>
                <ImgObject
                    href=" images/logos/logo-with-text-white.pdf"
                    label="Logo with text (white background)"
                >
                    <PdfIcon className={`max-w-[95%] absolute m-[1px]`} />
                </ImgObject>
            </ul>
            ...
            <ul className=" flex flex-wrap gap-2">
                <ImgObject
                    href="images/logos/logo-editable.svg"
                    label="Colourable SVG"
                    bordered={true}
                >
                    <object
                        data="images/logos/logo-editable.svg"
                        className={`max-w-[95%] absolute m-[1px]`}
                        type="image/svg+xml"
                    />
                </ImgObject>
                ...
                >
                    <object
                        data="images/logos/logo.svg"
                        className={`max-w-[95%] absolute m-[1px]`}
                        type="image/svg+xml"
                    />
                </ImgObject>
                <ImgObject
                    href="images/logos/logo-with-text.svg"
                    label="Logo with text (inkscape)"
                >
                    <InkscapeIcon
                        className={`scale-[0.3] origin-top-left absolute m-[1px]`}
                    />
                </ImgObject>
            </ul>
        </>
...
function ImgObject({
    ...
    return (
        <li className="w-1/4 relative flex flex-col">
            {children}
            {/** biome-ignore lint/a11y/useAnchorContent: it'll have an image inside it */}
            <a
                href={href}
